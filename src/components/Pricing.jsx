    ...
    <section id="pricing" className="py-20 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <motion.div 
          ...
          className="absolute bottom-20 right-20 w-60 h-60 bg-pink-300 rounded-full blur-3xl opacity-30"
        />
        <motion.div 
          animate={{ 
            y: [5, -5, 5], 
          ...
          className="absolute top-1/2 left-1/3 w-32 h-32 bg-yellow-300 rounded-full blur-3xl opacity-20"
        />
      </div>
        ...
        >
          <div className="inline-block relative mb-4">
            <motion.span
              ...
              className="absolute bottom-0 left-0 h-3 bg-gradient-to-r from-purple-400 to-pink-400 opacity-60 rounded-full"
            ></motion.span>
        ...
        >
          <div className="relative">
            ...
            <motion.div
              ...
              className="absolute -top-8 -right-8 w-24 h-24 bg-yellow-100 rounded-lg shadow-lg flex items-center justify-center transform rotate-12 z-20 border-2 border-yellow-300"
            >
            ...
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden relative z-10 border-t-4 border-purple-600">
              ...
              <div className="p-8">
                ...
                <div className="space-y-6 mb-8">
                  <motion.div 
                    whileHover={{ x: 8 }}
                    className="flex items-center bg-purple-50 p-4 rounded-xl"
                  >
                  ...
                  <motion.div 
                    whileHover={{ x: 8 }}
                    className="flex items-center bg-fuchsia-50 p-4 rounded-xl"
                  >
                  ...
                  <motion.div 
                    whileHover={{ x: 8 }}
                    className="flex items-center bg-pink-50 p-4 rounded-xl"
                  >
                  ...
                  <motion.div 
                    whileHover={{ x: 8 }}
                    className="flex items-center bg-indigo-50 p-4 rounded-xl"
                  >
                ...
                >
                  ...
                  <button 
                    className="relative w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-4 px-6 rounded-full font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center"
